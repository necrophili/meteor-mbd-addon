...
public class AutoMountBypassDupe extends Module {
    ...
    private final Setting<Integer> delay = sgGeneral.add(new IntSetting.Builder().name("delay").description("The delay in seconds between actions.").defaultValue(4).min(0).sliderRange(0,30).build());
